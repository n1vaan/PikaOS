...
const ui_theme_variable_t _ui_theme_color_Default_Yellow[1] = {0xFFBA00};
const ui_theme_variable_t _ui_theme_alpha_Default_Yellow[1] = {255};

const ui_theme_variable_t _ui_theme_color_Red[1] = {0xD41800};
