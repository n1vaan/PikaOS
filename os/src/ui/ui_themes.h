...
#define UI_THEME_COLOR_DEFAULT_YELLOW 0
#define UI_THEME_COLOR_RED 1

#define UI_THEME_DEFAULT 0

extern const ui_theme_variable_t _ui_theme_color_Default_Yellow[1];
extern const ui_theme_variable_t _ui_theme_alpha_Default_Yellow[1];
